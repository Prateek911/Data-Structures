class LinkList_Trial{

	// Reference to first Link in list
	// The last Link added to the LinkedList

	public Link_Trial firstLink;
	...
	public void insertFirstLink(String bookName, int millionsSold){
		...
		Link_Trial newLink = new Link_Trial(bookName, millionsSold);
	...
	public Link_Trial removeFirst(){

		Link_Trial linkReference = firstLink;
	...
	public Link_Trial find(String bookName){
	...
	public Link_Trial removeLink(String bookName){

		Link_Trial currentLink = firstLink;
		Link_Trial previousLink = firstLink;
